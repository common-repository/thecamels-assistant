...
// EXTERNAL MODULE: ./assets/src/scss/main.scss
var main = __webpack_require__(2);

// CONCATENATED MODULE: ./assets/src/js/components/checkbox.js
...
function () {
  ...
  _createClass(Checkbox, [{
    key: "init",
    value: function init() {
      _toConsumableArray(this.items).forEach(this.listenChanges);
    }
  }, {
    key: "listenChanges",
    value: function listenChanges(item) {
      var checkboxes = item.querySelector('input[type="checkbox"]');
      checkboxes.addEventListener('change', this.highlightItem);
      checkboxes.addEventListener('change', this.saveItemState);
    }
  }, {
    key: "highlightItem",
    value: function highlightItem(event) {
      var checkbox = event.currentTarget;
      var itemWrap = checkbox.parentElement.parentElement;
    ...
    key: "saveItemState",
    value: function saveItemState(event) {
      var checkbox = event.currentTarget;
      /* global ajaxurl */

      external_jQuery_default.a.post(ajaxurl, {
